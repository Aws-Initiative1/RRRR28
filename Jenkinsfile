node {
    try {
            ...
            stage('Build and Quality Analysis'){
                            ...
                            stage('Build'){
                                echo 'Build'
                                checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '345c79bc-9def-4981-94b5-d8190fdd2304', url: 'https://github.com/Aws-Initiative1/RRRR28.git']]])
                            }
